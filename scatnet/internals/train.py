...
from ..internals.losses import  loss_mse, loss_mae,loss_ce, loss_thresh_weighted_decay
...
def prepare_model(model, optimizer, loss, metrics=('mse','mae','ce'),
