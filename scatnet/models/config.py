...
class Config(argparse.Namespace):
    ...
    unet_residual : bool
        Parameter `residual` of :func:`scatnet.nets.common_unet`. Default: ``n_channel_in == n_channel_out``
    unet_n_depth : int
        Parameter `n_depth` of :func:`scatnet.nets.common_unet`. Default: ``3``
    unet_kern_size : int
        Parameter `kern_size` of :func:`scatnet.nets.common_unet`. Default: ``5 if n_dim==2 else 3``
    unet_n_first : int
        Parameter `n_first` of :func:`scatnet.nets.common_unet`. Default: ``32``
    unet_last_activation : str
        Parameter `last_activation` of :func:`scatnet.nets.common_unet`. Default: ``linear``
    train_loss : str
        Name of training loss. Default:  'mse'
    train_epochs : int
    ...
    def __init__(self, axes, n_channel_in=1, n_channel_out=1, **kwargs):
        """See class docstring."""
